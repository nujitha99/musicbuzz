...
<head>
    <title>MusicBuzz | Profiles</title>
        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-8">
                        <h2>Welcome <?php echo $userdata[0]->username ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-7">
                    <div class="column middle">
                        <h4>Search for users by genre</h4>
                        <form action="/w1742286/index.php/Profiles/search" method="post">
                            <div class="form-group">
                                <label>Choose the genre to filter</label>
                    ...
                    if ($searchResult) {
                    ?>
                        <?php foreach ($searchResult as $res) { ?>
                                ...
                                <div class="column middle">
                                    <form action="/w1742286/index.php/Profiles/follow" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <a href="/w1742286/index.php/Profiles/viewProfile/<?= $res->username ?>/<?= var_export($res->isFollowing, true) ?>">
                                                    <p style="font-weight: bold;"> <?= $res->username ?> </p>
                                                </a>
                                                <input type="hidden" name="followUser" value="<?= $res->username ?>" />
                                                <p><?= $res->genreName ?></p>
                                            </div>
                                            <div class="col">
                                                <?php if (!$res->isFollowing) { ?>
